...
import com.bw.realtime.base.TrafficPageViewBean;
...
public class DwsTrafficVcChArIsNewPageViewWindow extends BaseApp {
    public static void main(String[] args) {
        new DwsTrafficVcChArIsNewPageViewWindow().start(Constant.TOPIC_DWD_TRAFFIC_PAGE,"1",1,10022);
    }
    @Override
    public void handle(StreamExecutionEnvironment env, DataStreamSource<String> dataStreamSource) {
        // 1. 解析数据, 封装 pojo 中
        SingleOutputStreamOperator<TrafficPageViewBean> beanStream = parseToPojo(dataStreamSource);
        // 2. 开窗聚合
...
//        writeToDoris(result);
    ...
    private SingleOutputStreamOperator<TrafficPageViewBean> windowAndAgg(SingleOutputStreamOperator<TrafficPageViewBean> beanStream) {
        return beanStream.assignTimestampsAndWatermarks(
                ...
                .reduce(
                        ...
                        new ProcessWindowFunction<TrafficPageViewBean, TrafficPageViewBean, String, TimeWindow>() {
                            ...
                            public void process(String key,
                                ...
                                bean.setCur_date(DateFormatUtil.tsToDateForPartition(ctx.currentProcessingTime()));
