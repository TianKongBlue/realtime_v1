...
import com.bw.realtime.bean.TradeSkuOrderBean;
import com.bw.realtime.constant.Constant;
import com.bw.realtime.function.AsyncDimFunction;
...
public class DwsTradeSkuOrderWindowAsync extends BaseApp {
    public static void main(String[] args) {
        new DwsTradeSkuOrderWindowAsync().start(Constant.TOPIC_DWD_TRADE_ORDER_DETAIL,"2",1,10031);
    ...
    private SingleOutputStreamOperator<TradeSkuOrderBean> windowAndAgg(
        ...
        return beanStream
            .assignTimestampsAndWatermarks(
                WatermarkStrategy
                    .<TradeSkuOrderBean>forBoundedOutOfOrderness(Duration.ofSeconds(10))
        ...
        return stream
            .map(new MapFunction<String, TradeSkuOrderBean>() {
                ...
                public TradeSkuOrderBean map(String value) throws Exception {
                    ...
                    BigDecimal order_price = obj.getBigDecimal("order_price");
                    BigDecimal sku_num = obj.getBigDecimal("sku_num");
//                    .originalAmount(obj.getBigDecimal("split_original_amount"))
                    return TradeSkuOrderBean.builder()
                        .skuId(obj.getString("sku_id"))
                        .orderDetailId(obj.getString("id"))
                        .originalAmount(order_price.multiply(sku_num))
