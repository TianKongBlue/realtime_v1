package com.bw.realtime.function;

import com.alibaba.fastjson.JSONObject;
import com.bw.realtime.bean.TableProcessDim;
import com.bw.realtime.bean.TableProcessDwd;
import com.bw.realtime.util.JdbcUtil;
...
public class DwdProcessFunction extends BroadcastProcessFunction<JSONObject, TableProcessDwd, Tuple2<JSONObject, TableProcessDwd>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        List<TableProcessDwd> tableProcessDwds = JdbcUtil.queryList(mysqlConnection, "select * from realtime.table_process_dwd", TableProcessDwd.class, true);
