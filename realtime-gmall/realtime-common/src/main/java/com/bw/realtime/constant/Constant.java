...
public class  Constant {
    ...
    public static final String PROCESS_DATABASE = "realtime";
    ...
    public static final String FENODES = "hadoop101:8030";
    public static final String DORIS_DATABASE = "gmall";
